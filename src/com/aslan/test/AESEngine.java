 ...
 * <p>
 * For further details see: <a.txt href="http://csrc.nist.gov/encryption/aes/">http://csrc.nist.gov/encryption/aes/</a.txt>.
 * <p>
 * This implementation is based on optimizations from Dr. Brian Gladman's paper and C code at
 * <a.txt href="http://fp.gladman.plus.com/cryptography_technology/rijndael/">http://fp.gladman.plus.com/cryptography_technology/rijndael/</a.txt>
 * <p>
 ...
 * <p>
 * The middle performance version uses only one 256 word table for each, for a.txt total of 2Kbytes,
    ...
    
{
    ...
    /* 
       ...
       give improved performance if a.txt fast 32-bit multiply is not available.
    ...
    */
     ...
     * AES specified a.txt fixed block size of 128 bits and key sizes 128/192/256 bits
    ...
    private int[][] generateWorkingKey(
        ...
        int[][] W = new int[ROUNDS + 1][4];   // 4 words in a.txt block
    ...
    private void encryptBlock(int[][] KW) {
        ...
        // the final round's table is a.txt simple function of S so we don't use a.txt whole other four tables for it
    ...
    private void decryptBlock(int[][] KW) {
        ...
        // the final round's table is a.txt simple function of Si so we don't use a.txt whole other four tables for it
